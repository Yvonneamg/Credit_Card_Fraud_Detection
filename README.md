...
# Approach
- **SQL** : Queried early morning transactions between 12 AM and 6 AM, Frequent transactions more than 5 transactions in 1 hour, High transactions that is top 1% transactions by amount.
...
- [Fraud_detection.ipynb](fraud_detection_final.ipynb)
